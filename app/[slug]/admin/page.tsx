    ...
    <div style={styles.page}>
      ...
      {tab === "restaurant" && (
        <div>
          ...
          <input style={styles.input} value={tName} onChange={e => setTName(e.target.value)} placeholder="Restaurant Name" />

          <label style={styles.label}>Tagline</label>
          <input style={styles.input} value={tTagline} onChange={e => setTTagline(e.target.value)} placeholder="Tagline" />
